...
class ProjectService:
    ...
    def update_project(self, project_id: int, name: str, description: str) -> Project:
        ...
        existing_names = [proj.name for proj in self.project_storage.get_all() if proj.id != project_id]
        validate_unique_name(existing_names, name, "project")
    ...
    def delete_project(self, project_id: int) -> bool:
        ...
        tasks_deleted = self.task_storage.delete_by_project_id(project_id)
