...
class TestProjectService:
    ...
    def test_create_project_success(self):
        ...
        project = self.project_service.create_project("Test Project", "Test Description")
...
class TestTaskService:
    def setup_method(self):
        ...
        self.project = self.project_service.create_project("Test Project", "Test Description")
